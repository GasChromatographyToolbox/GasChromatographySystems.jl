...
#@testset "example systems" begin
    ...
    # graph to parameters
    p2fun_series = build_pressure_squared_functions(ex_series)
    ...
    p2fun_split = build_pressure_squared_functions(ex_split)
    ...
    p2fun_GCxGC_TM = build_pressure_squared_functions(ex_GCxGC_TM)
