...
optTM = GasChromatographySystems.ModuleTMOptions(Tcold_abs=false, ng=true, alg=Vern9(), tflank=20.0, sflank=Inf, dtinit=0.5e-7)
...
# ╔═╡ 4c884abe-5386-4644-8c0d-98157a698375
GCxGC_TP
...
begin
	sys = GasChromatographySystems.GCxGC_TM(L1, d1, df1, sp1, TP1, L2, d2, df2, sp2, TP2, LTL, dTL, dfTL, spTL, TTL, LM, dM, dfM, spM, shift, PM, ratio, Thot, Tcold, TPM, F, pin, pout; opt=GasChromatographySystems.Options(), optTM=optTM, optCol=optCol)
end
...
selected_solutes = selected_solutes_[[1:16; [33, 34, 35, 36, 37, 38, 80, 81, 82, 83, 84, 86, 127, 128, 129, 130, 131, 132]]]#[Not([1, 29, 30])]#[[14,16,17]]
...
# ╔═╡ 169744fb-999a-494d-9312-8633efbd5603
sim[2][1][3]
...
# ╔═╡ 7bf2913d-66f4-46ec-8a4d-d431028bfe4a
sim[2][1][5]
