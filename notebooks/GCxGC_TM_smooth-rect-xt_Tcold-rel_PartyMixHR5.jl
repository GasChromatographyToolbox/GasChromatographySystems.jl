...
- smoothed rectangle temperature function in time and space at modulation point (`spatial=true`, `tflank=20`, `sflank=40`, `algTM=Vern9()` and `ng=false`)
- Tcold is relative (`Tcold_abs=false`)
"""

# ╔═╡ 1948baf0-1217-485a-8c8b-6e826bd5ef50
optTM = GasChromatographySystems.ModuleTMOptions(Tcold_abs=false, ng=false, alg=Vern9(), tflank=20.0, sflank=40, dtinit=0.5e-7)
...
begin
	sys = GasChromatographySystems.GCxGC_TM(L1, d1, df1, sp1, TP1, L2, d2, df2, sp2, TP2, LTL, dTL, dfTL, spTL, TTL, LM, dM, dfM, spM, shift, PM, ratio, Thot, Tcold, TPM, F, pin, pout; optTM=optTM, optCol=optCol)
end
...
selected_solutes = selected_solutes_[[37, 82, 130]]#[[33, 34, 35, 36, 37, 38, 80, 81, 82, 83, 84, 86, 127, 128, 129, 130, 131, 132]]#[Not([1, 29, 30])]#[[14,16,17]]
