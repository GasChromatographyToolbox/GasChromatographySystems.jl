...
sys = GasChromatographySystems.GCxGC_TM_simp(30.0, 0.25, 0.25, "ZB1ms", TP1, 2.0, 0.1, 0.1, "ZB1ms", TP1, 1.0, NaN, 0.0; opt=GasChromatographySystems.Options(ng=true))
...
begin
	db_m1 = DataFrame(CSV.File("/Users/janleppert/Documents/sciebo/GCsim/Estimator/GCsim_ZB1ms.csv", header=1, silencewarnings=true))
...
begin
	db_m2 = DataFrame(CSV.File("/Users/janleppert/Documents/sciebo/GCsim/Estimator/GCsim_ZB1ms_d.csv", header=1, silencewarnings=true))
	db_m2.Tchar = db_m2.Tchar .- 273.15
	db_m2
end

# ╔═╡ b15c6562-77f7-42fd-bdd8-003a0a68ff50
solutes = db_m1.Name[Not(6,17,22,23)]
...
pl_GCxGC_m1 = GasChromatographySystems.peaklist_GCxGC(pl_m1[1][1], pl_m1[1][2])

# ╔═╡ b44e068a-6850-42ed-8eca-4bb657d862e3
pl_GCxGC_m2 = GasChromatographySystems.peaklist_GCxGC(pl_m2[1][1], pl_m2[1][2])
...
begin
	plotly()
	p_GCxGC_m1 = plot_GCxGC(pl_GCxGC_m1, sys)
...
begin
	plotly()
	p_GCxGC_m2 = plot_GCxGC(pl_GCxGC_m2, sys)
	#Plots.plot!(p_GCxGC, legend=:topleft)
	p_GCxGC_m2
end
