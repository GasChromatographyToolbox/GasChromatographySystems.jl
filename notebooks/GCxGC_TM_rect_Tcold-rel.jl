...
optTM = GasChromatographySystems.ModuleTMopt(Tcold_abs=false, spatial=false, alg="simplifiedTM", tflank=Inf, sflank=Inf)
...
# 29 -> Warning "Peak width of focussed peaks > modulation period. Simulation is aborted."
# 30 -> Warning "Peak width of focussed peaks > modulation period. Simulation is aborted."
